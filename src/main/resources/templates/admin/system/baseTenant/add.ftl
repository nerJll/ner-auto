...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="limitDate" id="limitDate" lay-verify="date" placeholder="请选择到期时间"
...
<script>
    layui.use(['form', 'jquery', 'layer', 'laydate'], function () {
        ...
        form.on("submit(addBaseTenant)", function (data) {
            ...
            $.post("${base}/admin/baseTenant/add", data.field, function (res) {
                layer.close(loadIndex);
                if (res.success) {
                    parent.layer.msg("租户表添加成功！", {time: 1000}, function () {
