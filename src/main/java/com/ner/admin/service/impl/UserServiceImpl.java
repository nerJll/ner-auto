...
public class UserServiceImpl extends ServiceImpl<UserDao, User> implements UserService {
     ...
     * @see com.ner.service.UserService#findUserByLoginName(java.lang.String)
     */
     ...
     * 获取id-name map
     */
    public List<User> getIdNameMap(Long tenantId) {
        EntityWrapper<User> wrapper = new EntityWrapper<>();
        wrapper.setSqlSelect("id", "nick_name")
                .and()
                .isNull("tenant_id")
                .orderBy("nick_name", false);
        if (tenantId != null) {
            wrapper.or().eq("tenant_id", tenantId);
        }
