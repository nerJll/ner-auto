package com.ner.admin.aspect;

import com.alibaba.fastjson.JSONObject;
import com.ner.admin.base.MySysUser;
import com.ner.admin.entity.Log;
import com.ner.admin.exception.GlobalExceptionHandler;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.ner.admin.annotation.SysLog)")
    public void webLog() {
    }
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.ner.admin.annotation.SysLog mylog = method.getAnnotation(com.ner.admin.annotation.SysLog.class);
        if (mylog != null) {
            //注解上的描述
